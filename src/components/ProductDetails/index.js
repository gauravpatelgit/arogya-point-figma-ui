...
function Index() {
  ...
  return (
    <div className="p-6 bg-[#E7E7E3] ">
      <div className="flex flex-col gap-2 md:flex-row md:items-center md:justify-between ">
        <div className="pb-2">
          <h1 className="text-2xl font-bold text-gray-900">Product Details</h1>
          <p className="text-sm text-gray-600">
            Home <span className="text-gray-400">/</span> All Products{" "}
            <span className="text-gray-400">/</span> Product Details
          </p>
        </div>
      ...
      <div className="bg-white rounded-lg p-4">
        <div className="rounded-[28px] border-dashed border-gray-300 bg-white shadow-sm">
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-2 rounded-[14px] border border-black bg-gray-50 px-4 py-3">
                  {product.tags.map((tag) => (
                    <span
                      key={tag}
                      className="rounded-full bg-[#1AA428]  px-3 py-1 mb-8 text-xs font-no text-white"
                    >
                      {tag}
                    </span>
                  ))}
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-3">
                {[1, 2, 3].map((item) => (
                  <div
                    key={item}
                    className="flex items-center gap-3 rounded-[20px] border border-gray-200 bg-white px-4 py-3"
                  >
                    <img
                    ...
                    <span className="flex h-4 w-4 items-center justify-center rounded-full bg-green-600 text-white text-sm">
                      ✓
                    </span>
                  </div>
                ))}
